<template>
  <article class="prose prose-stone py-16 max-w-2xl m-auto px-8">
    ...
    <em>Last updated: September 4th, 2023</em>
    <p>
      Looking for our
    ...
    <p>
      ...
      Users or third parties), detect any malicious or fraudulent activity, as well as the following: Managing
      contacts and sending messages, Interaction with data collection platforms and other third parties,
      Infrastructure monitoring, Analytics, Traffic optimization and distribution, Hosting and backend
      infrastructure and Handling activities related to productivity.
    </p>
    <p>
    ...
    <p>
      This type of service helps the Owner to manage tasks, collaboration and, in general, activities related
      to productivity. In using this type of service, Data of Users will be processed and may be retained,
      depending on the purpose of the activity in question.
    </p>
    <p>
    ...
    <h4>Gmail (Google LLC)</h4>

    <p>
      Gmail is a service that manages email communication provided by Google LLC. Such email communication is
      not scanned by Google for advertising purposes. In addition, Google does not collect or use data inside
      this service for advertising purposes in any other way.
    </p>

    <p>Personal Data processed: email address; first name; last name.</p>
    <p>
      Place of processing: United States –
      <NuxtLink href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer"
    ...
    <p>
      This type of service has the purpose of hosting Data and files that enable this Application to run and
      be distributed as well as to provide a ready-made infrastructure to run specific features or parts of
      this Application.
    </p>
    ...
    <p>Scaleway is a cloud computing service provided by Scaleway SAS</p>

    <p>
      Personal Data processed: Various types of data may be processed for registered users of our hosted
      service, including email address, IP address, first name and last name.
    </p>

    <p>
      Place of processing: We utilise Scaleway's datacenters located in Amsterdam, Netherlands, and the
      processing of your data occurs within these facilities.
    </p>

    <!-- <h4>Hetzner</h4>
    <p>Hetzner is a hosting service provided by Hetzner Online GmbH.</p>
    <p>
    ...
    <h4>MongoDB</h4>
    <p>MongoDB is a database service provided by MongoDB Inc.</p>
    <p>
      Personal Data processed: various types of Data as specified in the privacy
      policy of the service.
    </p>
    ...
    <h4>Twillio Sendgrid</h4>
    <p>
      Twillio Sendgrid is an email address management and message sending
      service provided by Twillio Inc.
    </p>

    <p>
      Personal Data processed: email address; first name; last name; various
  ...
  -->
    ...
    <p>
      This type of service allows this Application to distribute their content using servers located across
    ...
    <p>
      ...
      implemented. Their function is to filter communications between this Application and the User's browser.
    </p>
    <p>
      Considering the widespread distribution of this system, it is difficult to determine the locations to
      which the contents that may contain Personal Information of the User are transferred.
    </p>

    <h4>Cloudflare (Cloudflare Inc.)</h4>

    <p>Cloudflare is a traffic optimization and distribution service provided by Cloudflare Inc.</p>
    <p>
      The way Cloudflare is integrated means that it filters all the traffic through this Application, i.e.,
      communication between this Application and the User's browser, while also allowing analytical data from
    ...
    <p>
      Place of processing: United States –
      <NuxtLink href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noopener noreferrer"
        >Privacy Policy </NuxtLink
      >.
    </p>
    ...
    <ul>
      <li>
        <strong>Withdraw their consent at any time.</strong> Users have the right to withdraw consent where
      ...
      <li>
        ...
        of their Data if the processing is carried out on a legal basis other than consent. Further details
        are provided in the dedicated section below.
      </li>
      <li>
        <strong>Access their Data.</strong> Users have the right to learn if Data is being processed by the
        Owner, obtain disclosure regarding certain aspects of the processing and obtain a copy of the Data
        undergoing processing.
      </li>
      <li>
        <strong>Verify and seek rectification.</strong> Users have the right to verify the accuracy of their
      ...
      <li>
        ...
        circumstances, to restrict the processing of their Data. In this case, the Owner will not process
      ...
      <li>
        <strong>Lodge a complaint.</strong> Users have the right to bring a claim before their competent data
    ...
    <p>
      ...
      they can object to that processing at any time without providing any justification. To learn, whether
      the Owner is processing Personal Data for direct marketing purposes, Users may refer to the relevant
    ...
    <p>
      ...
      in this document. These requests can be exercised free of charge and will be addressed by the Owner as
    ...
    <p>
      ...
      to possible legal action arising from improper use of this Application or the related Services.<br />The
      User declares to be aware that the Owner may be required to reveal personal data upon request of public
      authorities.
    </p>
    ...
    <p>
      The Owner reserves the right to make changes to this privacy policy at any time by notifying its Users
    ...
    <p>
      ...
      who use this Application, the URI addresses (Uniform Resource Identifier), the time of the request, the
